...
TOOL_NAME = "calendar_create_tool"
...
def calendar_create_tool(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        data = CalendarCreateInput.model_validate(safe_input)
    ...
    try:
        ...
        new_time = datetime.fromisoformat(data.scheduled_time_utc)
        ...
        return CalendarCreateOutput(
            ...
            scheduled_time_utc=interview.scheduled_time.isoformat(),
            error=None,
            trace=ToolTrace(
                tool_name=TOOL_NAME,
                trace_id=trace_id,
